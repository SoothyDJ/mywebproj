// File Path: /ai-services/openai-service.js
// OpenAI integration service for content analysis and generation
// REF-035: OpenAI service for video analysis and storyboard generation
        ...
        try {
            ...
            const response = await this.client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are an expert content analyzer specializing in video content analysis. Provide detailed, structured analysis of video content including themes, sentiment, and key insights.'
                    },
                    {
                        role: 'user',
                        content: prompt
        ...
        try {
            ...
            const response = await this.client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are a professional video storyboard creator. Generate detailed storyboard sequences for video narration based on the content analysis provided.'
                    },
                    {
                        role: 'user',
                        content: prompt
            ...
            const storyboard = this.parseStoryboardResponse(response.choices[0].message.content);
        ...
        try {
            ...
            const response = await this.client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are a professional content analyst creating comprehensive reports from video analysis data.'
                    },
                    {
                        role: 'user',
                        content: prompt
        ...
        try {
            const response = await this.client.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'user',
                        content: 'Respond with: OpenAI connection test successful'
                    }
                ],
                max_tokens: 50
            });
